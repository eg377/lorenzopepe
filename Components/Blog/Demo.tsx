...
/* 
TODO:
2 Check perf of loading iwth multiple code demos
3 Add bar on top of Demo with name(?) link to github code snippet and whatever else
4 Classname may affect too many styles. maybe just allow to pass properties such as width / height and variants...
5 Add accessibility
6 Use math formulas instead of getting pixel by try in cube
*/
